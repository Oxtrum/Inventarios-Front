    ...
    >
      <div
        className={cn(
          ...
          "group-data-[state=checked]:shadow-2xl group-data-[state=checked]:ring-highlight",
      ...
      >
        <CircleCheck
          className={cn(
            "size-6 fill-highlight stroke-highlight-foreground",
        ...
        <item.icon
          className={cn(
            !isTheme &&
              "fill-highlight stroke-highlight group-data-[state=unchecked]:fill-muted-foreground group-data-[state=unchecked]:stroke-muted-foreground"
          )}
          aria-hidden="true"
        />
      </div>
